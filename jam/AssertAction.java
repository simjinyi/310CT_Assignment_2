...
//////////////////////////////////////////////////////////////////////////////
//  
//  $Id: AssertAction.java,v 1.5 1998/11/04 18:15:31 marcush Exp marcush $
//  $Source: C:\\com\\irs\\jam\\RCS\\AssertAction.java,v $
//  
...
/**
 *
 * A built-in JAM primitive action for adding entries to
 * the JAM world model.
 *
 * @author Marc Huber
 * @author Jaeho Lee
...
public class AssertAction extends WorldModelAction implements Serializable
{
  ...
  /**
   * Constructor w/ relation to assert to the World Model as
   * an argument in addition to the interpreter.
   *
   */
  AssertAction(Relation relation, Interpreter interpreter)
  {
  ...
  {
    getInterpreter().getWorldModel().assert(_relation, b);
